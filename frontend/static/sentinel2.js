...
window.Sentinel2 = {
    ...
    createProductInterface() {
        ...
        product.innerHTML = `
            ...
            <div class="sentinel2-header">
                ...
                <div>
                    ...
                    <p>
                        ...
                        for GeoShield intelligence.
                    </p>

                </div>

                <div class="sentinel2-status"
                     id="sentinel2-status">
                    READY
                </div>
            ...
            <div class="sentinel2-controls">

                <div class="sentinel2-field">

                    <label for="sentinel-date-from">
                        FROM
                    </label>

                    <input
                        id="sentinel-date-from"
                        type="date"
                    >
            ...
            <div
                id="sentinel2-message"
                class="sentinel2-message">
                Searching for recent Sentinel-2 scenes...
            </div>

            <div
                id="sentinel2-results"
                class="sentinel2-results">
            </div>
